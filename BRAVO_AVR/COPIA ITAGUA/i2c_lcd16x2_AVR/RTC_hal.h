...
extern volatile uint8_t flagFecha;
extern volatile uint8_t flagHora;
extern volatile uint8_t DIA_ACTIVADO;
extern volatile uint8_t HORA_ACTIVADO;
extern volatile uint8_t MIN_ACTIVADO;
